...
- **CI**：全绿 · 17 路由全部 200
- **进度**：Sprint 33 已闭环（cninfo 真数据落库 + 3 家公司年报实测）
...
| 信源 | 状态 | 实测数据 |
|---|---|---|
| **akshare · 东方财富** | ✅ live | 8 家真实可比公司财报（寒武纪 / 海光 / 讯飞 / 联影 / 顺丰 / 拉卡拉 / 东航物流 / 石头 / 科沃斯 / 京东物流） |
| **企查查 · 工商画像** | ✅ live | 旷视科技工商画像（2011 / 印奇唐文斌杨沐 / 2000+ 员工） |
| **企查查 · 知识产权** | ✅ live | 旷视 434 条专利全量 |
| **巨潮资讯 · 年报** | ✅ live | 联影 2024 + 顺丰 2024 + 寒武纪 2024（共 6 份 PDF 直链） |
| **企查查 · 风险与司法** | 🔵 wired | 5 维（行政处罚/失信/被执行/经营异常/严重违法）— 单调试 stream 失败，待机会重试 |
