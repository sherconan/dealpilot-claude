...
export const sources: SourceConnector[] = [
  ...
  },
  {
    ...
    lastVerified: '2026-04-30',
    proofTitle: '旷视科技 3 维风险扫描实测',
    proofSummary: '逐项调用 qcc-risk 三个核心工具 → 旷视真实合规画像：仅 1 条 9,000 元消防小额处罚（2023-10），失信 / 经营异常均为 0。证明产品能识别"小额合规事件" vs"硬红线"两种颗粒度。',
    proofRows: [
      { k: '行政处罚', v: '1 条 · 顺义区消防救援支队 · ¥9,000 · 2023-10-07' },
      { k: '处罚文号', v: '顺(一)消行罚决字〔2023〕第100127号' },
      { k: '失信被执行', v: '0 条 · 同步排查限高 / 被执行均无' },
      { k: '经营异常', v: '0 条 · 工商正常经营状态' },
      { k: '机构判定', v: '小额合规事件，不影响投资 — 但需在 IC Memo 风险章节披露' },
    ],
  },
  {
