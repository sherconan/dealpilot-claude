...
export const sources: SourceConnector[] = [
  ...
  },
  {
    ...
    lastVerified: '已接入',
    proofTitle: '场景：BP 中提到的"对标 A 股已上市同行"',
    proofSummary: 'BP 声称对标 X 公司 → 接口直接拉 X 公司近 3 年年报 → 抽取核心财务 / 风险揭示 / 关联方交易，跟 BP 描述自动比对。',
    proofRows: [
      { k: '触发场景', v: 'BP 说"我们在 XX 业务上是 [上市公司] 的领先 1 代"' },
      { k: '调用动作', v: 'query_annual_reports_tool(searchKey: 上市公司)' },
      { k: '产出', v: '近 3 年年报 PDF 链接 + 自动摘要 + 与 BP 论断的吻合度评分' },
      { k: '已实测', v: '工具就绪，等待真实 BP 触发实战调用' },
    ],
  },
  {
    id: 'qcc-risk',
