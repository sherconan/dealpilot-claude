...
export const sources: SourceConnector[] = [
  ...
  },
  {
    ...
    proofRows: [
      { k: '联影医疗 (688271) 2024 年报', v: '全文 + 摘要 · 2025-04-29 公告' },
      { k: '顺丰控股 (002352) 2024 年报', v: '全文 + 摘要 · 2025-03-29 公告' },
      { k: '寒武纪 (688256) 2024 年报', v: '全文 + 摘要 · 2025-04-19 公告' },
      { k: 'PDF 直链', v: 'cninfo.com.cn/finalpage/.../1223362977.PDF · 1222943385.PDF · 1223155683.PDF' },
      { k: '使用场景', v: 'BP 声称对标 X 公司 → 一键拉年报 → 抽核心财务 / 风险 / 关联方 → 与 BP 论断自动比对' },
    ],
  },
  {
    id: 'qcc-risk',
