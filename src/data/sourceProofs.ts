...
export const sources: SourceConnector[] = [
  ...
  },
  {
    ...
    proofRows: [
      ...
      { k: '寒武纪 (688256)', v: '2024 年报 + 摘要 · 2025-04-19 · 1223155683.PDF' },
      { k: '拉卡拉 (300773)', v: '2024 年报 + 摘要 · 2025-04-25 · 1223276421.PDF' },
      { k: '东航物流 (601156)', v: '2024 年报 + 摘要 · 2025-04-17 · 1223112624.PDF' },
      { k: '石头科技 (688169)', v: '2024 年报 + 摘要 · 2025-04-04 · 1223005304.PDF' },
      { k: '科沃斯 (603486)', v: '2024 年报 + 摘要 · 2025-04-26 · 1223323879.PDF' },
      { k: '海光信息 (688041)', v: '2024 年报 + 摘要 · 2025-03-01 · 1222675682.PDF' },
      { k: '科大讯飞 (002230)', v: '2024 年报 + 摘要 · 2025-04-22 · 1223191180.PDF' },
    ],
  },
  {
    id: 'qcc-risk',
    ...
    lastVerified: '2026-04-30',
    proofTitle: '3 家公司 6 维风险扫描实测（旷视 / 字节 / 联影）',
    proofSummary: '产品能区分 4 种风险颗粒度：① 全干净（联影）② 小额合规（旷视消防 ¥9k）③ 监管处罚（字节网信办约谈）④ 硬红线（CryptoVault 演示）。每类对应不同投资决策。',
    proofRows: [
      { k: '旷视 · 行政处罚', v: '1 条 · 顺义消防 · ¥9,000 · 2023-10 · 文号 顺(一)消行罚决字〔2023〕第100127号' },
      { k: '字节 · 行政处罚', v: '1 条 · 国家网信办 · 2025-09-23 · 约谈 + 责令限期改正 + 警告（高级监管）' },
      { k: '联影 · 全维度', v: '处罚 / 失信 / 经营异常 全部 0 条 — 完美合规画像' },
      { k: '6 维度统一接口', v: 'get_administrative_penalty / get_dishonest_info / get_business_exception 等 5 工具' },
      { k: '机构判定', v: '小额事件 = 披露但不影响 · 监管处罚 = 量化拖累 · 硬红线 = 直接 Pass' },
    ],
  },
  {
